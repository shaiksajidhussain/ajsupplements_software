...
SECRET_KEY = 'django-insecure-#2efajb=%gr66@arj+k6=utwk=7u3303lng6uuc!cgu4lcx-6r'
...
INSTALLED_APPS = [
    ...
    'core.apps.CoreConfig',  # Use app config to ensure signals are loaded
]
